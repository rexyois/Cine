<div>
    ...
    <div id="myCarousel" class="carousel slide carousel-fade col-12" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset('img/1.jpg')); ?>" style="height: 768px">
                <div class="container">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(asset('img/2.jpg')); ?>" alt="" style="height: 768px">
                <div class="container">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(asset('img/3.jpg')); ?>" style="height: 768px">
                <div class="container">
    ...
    </div><?php /**PATH C:\laragon\www\cineR1\resources\views/layouts/carousel.blade.php ENDPATH**/ ?>