...
<form method= "post" action="<?php echo e(route('movies.store')); ?>">
    ...
    <div> 
        ...
        <input class="form-control" placeholder="Ingrese el nombre de la película" type="text" name="name" id="" maxlength="200" 
        minlength="2" required>
    </div>
    <div>
        <label>Sinopsis</label>
        <textarea class="form-control" placeholder="Agregue la sinopsis de la película" name="synopsis" id="" cols="30" 
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cineR1\resources\views/movies/create.blade.php ENDPATH**/ ?>